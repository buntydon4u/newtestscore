...
export class ExamController {
  ...
  async getSeries(req: Request, res: Response) {
    ...
    const series = await examService.getSeries(boardId as string);
    res.json(series);
  }
  ...
  async getBlueprints(req: Request, res: Response) {
    const { classId } = req.query;
    const blueprints = await examService.getBlueprints(classId as string);
    res.json(blueprints);
  }

  async getAcademicBoards(req: Request, res: Response) {
  ...
  async createBlueprint(req: AuthRequest, res: Response) {
  ...
  async createAcademicBoard(req: AuthRequest, res: Response) {
