...
router.get('/users', authMiddleware, superAdminMiddleware, asyncHandler(async (req, res) => {
...
router.get('/users/:id', authMiddleware, superAdminMiddleware, asyncHandler(async (req, res) => {
    const { id } = req.params;
...
router.post('/users', authMiddleware, superAdminMiddleware, asyncHandler(async (req, res) => {
...
router.put('/users/:id', authMiddleware, superAdminMiddleware, asyncHandler(async (req, res) => {
    const { id } = req.params;
...
router.delete('/users/:id', authMiddleware, superAdminMiddleware, asyncHandler(async (req, res) => {
    const { id } = req.params;
    const user = await prisma.user.findUnique({
        where: { id, isDeleted: false },
    });
