...
router.get('/', cacheMiddleware('system-configurations'), asyncHandler(async (req, res) => {
...
router.post('/', authMiddleware, roleMiddleware('ADMIN', 'SUPER_ADMIN'), asyncHandler(async (req, res) => {
...
router.put('/:key', authMiddleware, roleMiddleware('ADMIN', 'SUPER_ADMIN'), asyncHandler(async (req, res) => {
    const { key } = req.params;
...
router.delete('/:key', authMiddleware, roleMiddleware('ADMIN', 'SUPER_ADMIN'), asyncHandler(async (req, res) => {
    const { key } = req.params;
    const oldConfig = await configService.getConfig(key);
...
router.patch('/:key/toggle', authMiddleware, roleMiddleware('ADMIN', 'SUPER_ADMIN'), asyncHandler(async (req, res) => {
    const { key } = req.params;
    const oldConfig = await configService.getConfig(key);
